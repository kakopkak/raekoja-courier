...
export function generateMap(): number[][] {
  ...
  // North row (Pikk tänav side): rows 13-15, cols 22-34
  const northRow = [22, 25, 28, 31, 34];
...
export function generateBuildings(): Building[] {
  ...
  const houses: Array<{ id: string, name: string, x: number, y: number, w: number, h: number }> = [
    ...
    { id: "kangur", name: "Kanguri maja", x: 25, y: 13, w: 3, h: 3 },
    { id: "kaupmees", name: "Suurgildi hoov", x: 28, y: 13, w: 3, h: 3 },
    { id: "kirjutaja", name: "Kirjutaja koda", x: 31, y: 13, w: 3, h: 3 },
    { id: "tolner", name: "Tölneri maja", x: 34, y: 13, w: 3, h: 3 },
